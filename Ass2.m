...
% FAM_XPosError_TruckAngleError = {'ZE','PS','PM','PM','PM';...
%                                 'NS','ZE','PS','PM','PM';...
%                                 'NM','NS','ZE','PS','PM';...
%                                 'NM','NM','NS','ZE','PS';...
%                                 'NM','NM','NM','NS','ZE'};
...
UCOAoutputFiringRules = determineRules(truckAngleErrorFuzzyified,xPosErrorFuzzyified,'COA-min',setTruckAngleError,setXPosError,setOutput,FAM_TruckAngleError_XPosError);
...
for i = 1:(numSamplingPoints-1)
    ...
    UMOMoutputFiringRules = determineRules(truckAngleErrorFuzzyified,xPosErrorFuzzyified,'MOM-prod',setTruckAngleError,setXPosError,setOutput,FAM_TruckAngleError_XPosError);
